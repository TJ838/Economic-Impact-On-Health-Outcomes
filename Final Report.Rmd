...
Source on Github: https://github.com/TJ838/Economic-Impact-On-Health-Outcomes
...
kable(clean_health_summary, format = "html", caption = "Table 1: Summary Statistics of Health Indicators") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"), 
                full_width = FALSE, 
                position = "center") %>%
...
kable(clean_economic_summary, format = "html", caption = "Table 2: Summary Statistics of Economic Indicators") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"), 
                full_width = FALSE, 
                position = "center") %>%
  row_spec(0, bold = TRUE, background = "#f2f2f2") %>%
...
ggplot(merged_data, aes(x = log_gdp, y = life_expectancy)) + 
...
ggplot(merged_data, aes(x = log_unemployment_rate, y = mortality_rate)) + 
...
ggplot(merged_data, aes(x = log_inflation_rate, y = immunization_rate)) + 
...
ggplot(merged_data, aes(x = log_gdp, y = water_access)) + 
...
ggplot(merged_data, aes(x = log_gdp, y = sanitation_access)) + 
...
ggplot(merged_data, aes(x = log_unemployment_rate, y = life_expectancy)) + 
...
scaled_data <- merged_data %>%
  mutate(
    log_gdp = scale(log_gdp),
    log_inflation_rate = scale(log_inflation_rate),
    log_unemployment_rate = scale(log_unemployment_rate),
    year = scale(year)
  )

predictors <- c("log_gdp", "log_inflation_rate", "log_unemployment_rate", "year")

health_outcomes <- c("life_expectancy", "mortality_rate", "immunization_rate", "water_access", "sanitation_access")

i <- 1  

outcome <- health_outcomes[i]
cat("\n============================\n")
cat("Modeling for:", outcome, "\n")
cat("============================\n")
...
set.seed(42)
train_index <- createDataPartition(model_data[[outcome]], p = 0.8, list = FALSE)
...
lm_rmse <- sqrt(mean((test_data[[outcome]] - lm_pred)^2))

rf_model <- randomForest(formula, data = train_data, importance = TRUE)
rf_pred <- predict(rf_model, newdata = test_data)
rf_rmse <- sqrt(mean((test_data[[outcome]] - rf_pred)^2))
...
cat("Linear Regression Summary for", outcome, "\n")
print(summary(lm_model))

cat("Random Forest Variable Importance for", outcome, "\n")
print(importance(rf_model))
varImpPlot(rf_model, main = paste("RF Importance for", outcome))

aug <- augment(lm_model)
resid_plot <- ggplot(aug, aes(x = .fitted, y = .resid)) +
  geom_point(alpha = 0.6, color = "purple") +
  geom_hline(yintercept = 0, linetype = "dashed", color = "red") +
  labs(
    x = "Fitted Values",
    y = "Residuals",
    caption = paste("Figure 15: Residual Plot for Life Expectancy") ) +
  theme_minimal() +
  theme(plot.caption = element_text(hjust = 0.5, size = 12, face = "bold"))

qq_plot <- ggplot(aug, aes(sample = .resid)) +
  stat_qq(alpha = 0.6, color = "darkblue") +
  stat_qq_line(color = "red") +
  labs(
    x = "Theoretical Quantiles",
    y = "Sample Quantiles",
    caption = paste("Figure 20: Q-Q Plot for Life Expectancy")
  ) +
  theme_minimal() +
  theme(plot.caption = element_text(hjust = 0.5, size = 12, face = "bold"))
...
cat("Variance Inflation Factors (VIF) for", outcome, "\n")
print(vif(lm_model))
```
...
results <- tibble(Model = c("Linear Regression", "Random Forest"), RMSE = c(lm_rmse, rf_rmse))
print(results)
print(summary(lm_model))
print(importance(rf_model))
varImpPlot(rf_model, main = paste("RF Importance for", outcome))
...
resid_plot <- ggplot(aug, aes(x = .fitted, y = .resid)) +
  ...
  labs(x = "Fitted Values", y = "Residuals",
       caption = paste("Figure 16: Residual Plot for Mortality Rate")) +
  theme_minimal() +
  theme(plot.caption = element_text(hjust = 0.5, size = 12, face = "bold"))

qq_plot <- ggplot(aug, aes(sample = .resid)) +
  stat_qq(alpha = 0.6, color = "tomato") +
  stat_qq_line(color = "red") +
  labs(x = "Theoretical Quantiles", y = "Sample Quantiles", 
       caption = paste("Figure 21: Q-Q Plot for Mortality Rate")) +
  theme_minimal() +
  theme(plot.caption = element_text(hjust = 0.5, size = 12, face = "bold"))
...
resid_plot <- ggplot(aug, aes(x = .fitted, y = .resid)) +
  ...
  geom_hline(yintercept = 0, linetype = "dashed", color = "red") +
  labs(x = "Fitted Values", y = "Residuals", 
       caption = paste("Figure 17: Residual Plot for Immunization Rate")) +
  theme_minimal() +
  theme(plot.caption = element_text(hjust = 0.5, size = 12, face = "bold"))

qq_plot <- ggplot(aug, aes(sample = .resid)) +
  stat_qq(alpha = 0.6, color = "forestgreen") +
  stat_qq_line(color = "red") +
  labs(x = "Theoretical Quantiles", y = "Sample Quantiles",
       caption = paste("Figure 22: Q-Q Plot for Immunization Rate")) +
  theme_minimal() +
  theme(plot.caption = element_text(hjust = 0.5, size = 12, face = "bold"))
...
resid_plot <- ggplot(aug, aes(x = .fitted, y = .resid)) +
  ...
  geom_hline(yintercept = 0, linetype = "dashed", color = "red") +
  labs(x = "Fitted Values", y = "Residuals", 
       caption = paste("Figure 18: Residual Plot for Water Access")) +
  theme_minimal() +
  theme(plot.caption = element_text(hjust = 0.5, size = 12, face = "bold"))

qq_plot <- ggplot(aug, aes(sample = .resid)) +
  stat_qq(alpha = 0.6, color = "darkcyan") +
  stat_qq_line(color = "red") +
  labs(x = "Theoretical Quantiles", y = "Sample Quantiles",
       caption = paste("Figure 23: Q-Q Plot for Water Access")) +
  theme_minimal() +
  theme(plot.caption = element_text(hjust = 0.5, size = 12, face = "bold"))
...
resid_plot <- ggplot(aug, aes(x = .fitted, y = .resid)) +
  ...
  geom_hline(yintercept = 0, linetype = "dashed", color = "red") +
  labs(x = "Fitted Values", y = "Residuals", 
       caption = paste("Figure 19: Residual Plot for Sanitation Access")) +
  theme_minimal() +
  theme(plot.caption = element_text(hjust = 0.5, size = 12, face = "bold"))

qq_plot <- ggplot(aug, aes(sample = .resid)) +
  stat_qq(alpha = 0.6, color = "orange") +
  stat_qq_line(color = "red") +
  labs(x = "Theoretical Quantiles", y = "Sample Quantiles", 
       caption = paste("Figure 24: Q-Q Plot for Sanitation Access")) +
  theme_minimal() +
  theme(plot.caption = element_text(hjust = 0.5, size = 12, face = "bold"))
